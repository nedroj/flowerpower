...
@section('content')
            ...
            <div class="col-md-3 text-center">
                <ul class="list-unstyled mb-0">
                    ...
                    <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                        <h6>infomailflowerpower@gmail.com</h6>
                    </li>
                </ul>
            </div>
    ...
    <div class="space space-10"><hr></div>
        ...
        <div class="row">
            ...
            <div class="col-sm-5 no-space">
                <div class="contact-social-title">
                    <div class="google-map">
                        <img src="https://dgivdslhqe3qo.cloudfront.net/careers/photos/28085/normal_photo_1489830153.jpg">
                    </div>
                    <h4>Openingstijden </h4>
                    <ul class="my-5">
                        <li> Maandag: 12:00 - 20:00</li>
                        <li> Dinsdag: 12:00 - 20:00</li>
                        <li> Woensdag: 12:00 - 20:00</li>
                        <li> Donderdag: 12:00 - 20:00</li>
